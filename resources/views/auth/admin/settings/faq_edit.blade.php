...
@section('content')
	<div class="row">
		<div class="col-md-4">
		<h3>New FAQs</h3>
		{!! Form::open(['action'=>'AdminController@faq_update','method'=>'post','role'=>'form']) !!}
			@foreach($faq->get() as $item)
			<div class="form-group">
				{!! Form::label('question','Question') !!}
              	<div class="col-md-12">
              		{!! Form::hidden('id',$item->id) !!}
	                {!! Form::textarea('question',$item->question,['placeholder'=>'Question','rows'=>7,'class'=>'form-control col-md-12 col-xs-12']) !!}
	                @if($errors->has())
			...
			<div class="form-group">
				{!! Form::label('answer','Answer') !!}
              	<div class="col-md-12">
	                {!! Form::textarea('answer',$item->answer,['placeholder'=>'Answer','rows'=>7,'class'=>'form-control col-md-12 col-xs-12']) !!}
	                @if($errors->has())
			...
			<div class="form-group">
				{!! Form::label('Status','Status') !!}
              	<div class="col-md-12">
		            <div class="checkbox">
		                <label>
		                  <input name="status" value="1" @if($item->status == 1) checked @endif type="checkbox"> Actived
		                </label>
		            </div>
					@if($errors->has())
